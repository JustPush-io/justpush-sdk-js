...
| `button`          | `(cta: string, url: string, actionRequired: boolean)`                                                                                                                                 | Adds a button to the message                                             |
| `buttons`         | `(buttons: Array<button>)`                                                                                                                                                            | Adds multiple buttons to the message                                     |
| `buttonGroups`    | `(groups: Array<{name: string, cta: string, action_required: boolean, buttons: button>}>)`                                                                                            | Adds groups of buttons to the message, each with its own name and CTA    |
